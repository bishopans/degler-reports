...
const CATEGORY_META: Record<string, { icon: string; imageUrl?: string; description: string }> = {
  ...
  'Athletic Equipment': { icon: '🏀', imageUrl: 'https://cdn11.bigcommerce.com/s-8jy95dyy51/images/stencil/659x659/products/4171/6013/1635108-1635080C1304_PortableBackstop__35402.1766172435.jpg?c=1', description: 'Basketball goals, volleyball systems, and gym equipment' },
